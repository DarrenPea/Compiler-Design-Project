file:///C:/Users/peada/OneDrive%20-%20Singapore%20University%20of%20Technology%20and%20Design/Term%207/Compiler/Compiler-Design-Project/simp/src/main/scala/sutd/compiler/simp/ir/SSA.scala
...
action parameters:
offset: 2509
uri: file:///C:/Users/peada/OneDrive%20-%20Singapore%20University%20of%20Technology%20and%20Design/Term%207/Compiler/Compiler-Design-Project/simp/src/main/scala/sutd/compiler/simp/ir/SSA.scala
text:
```scala
...
object SSA {
    ...
    def insertPhis(pa:List[LabeledInstr], dft:DFTable, g:CFG):P = {
        ...
        val e:E = labels_modded_vars.foldLeft(Map():E) {
            case (acc:E, (l, vars)) =>
                vars.foldLeft(acc) { (acc1:E, v:String) =>
                    val phiLabels = dfPlus(dft, List(l))
                    phiLabels.foldLeft(acc2) { (acc3:E, label:Label) =>
                        acc3.get(label) match {
                            case None => acc3 + (label -> List(v))
                            case Some(vs) => if (vs.contains(v)) acc3 else acc3 + (label -> (vs ++ List(v@@)))
                        }}
                }
        }
